...
$(document).ready(function() {
    ...
    if (scrollTop > 15) {
        ...
        $(".section-1").css("background", "linear-gradient(to right top, #6d327c, #485DA6, #00a1ba, #00BF98, #36C486)");

        $(".section-1 p").css("color", "white");
        $(".section-1 h1").css("color", "white");
       
        
        // $(".section-2").css("background", "linear-gradient(to right top, #6d327c, #00a1ba,  #36C486, #6d327c, #485DA6)");
    }
    else {
    ...
    if (remainingPercentage <= 20) {
      ...
      $(".section-3").css("background", "linear-gradient(to right top, #6d327c, #485DA6, #00a1ba, #00BF98, #36C486)");
